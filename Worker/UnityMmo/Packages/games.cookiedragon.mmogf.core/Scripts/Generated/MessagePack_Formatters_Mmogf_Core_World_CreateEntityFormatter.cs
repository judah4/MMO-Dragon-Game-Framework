...
namespace MessagePack.Formatters.Mmogf.Core
{
    ...
    public sealed class World_CreateEntityFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Mmogf.Core.World.CreateEntity>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Mmogf.Core.World.CreateEntity value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            formatterResolver.GetFormatterWithVerify<global::Mmogf.Core.CreateEntityRequest?>().Serialize(ref writer, value.Request, options);
        ...
        public global::Mmogf.Core.World.CreateEntity Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                {
                    case 0:
                        ____result.Request = formatterResolver.GetFormatterWithVerify<global::Mmogf.Core.CreateEntityRequest?>().Deserialize(ref reader, options);
                        break;
                    case 1:
