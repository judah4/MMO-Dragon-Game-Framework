...
namespace MessagePack.Formatters.Mmogf.Core
{
    ...
    public sealed class EntityWorldConfigFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Mmogf.Core.EntityWorldConfig>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Mmogf.Core.EntityWorldConfig value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            formatterResolver.GetFormatterWithVerify<global::System.Collections.Generic.Dictionary<int, IEntityComponent>>().Serialize(ref writer, value.EntityData, options);
        }
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        ____result.EntityData = formatterResolver.GetFormatterWithVerify<global::System.Collections.Generic.Dictionary<int, IEntityComponent>>().Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
                        break;
