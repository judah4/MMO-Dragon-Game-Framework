...
namespace Mmogf.Servers.Tests.Worlds
{
    ...
    {
        GridLayer GetWorldGridWithDefaultLayer(ISerializer serializer, int cellSize, bool addEntity)
        {
            return GetWorldGrid(serializer, cellSize, addEntity, new GridLayerIdentifier(0));
        }

        GridLayer GetWorldGrid(ISerializer serializer, int cellSize, bool addEntity, GridLayerIdentifier layer)
        {
            var grid = new GridLayer(cellSize, layer);

            if (addEntity)
            {
                grid.AddEntity(CreateEntity(serializer, new Position(1, 1, 1)));
            }
        ...
        public void GetCell_Test()
        {
            ...
            var cellSize = 50;
            var grid = GetWorldGridWithDefaultLayer(serializer, cellSize, false);
        ...
        public void AddEntity_Test()
        {
            ...
            var cellSize = 50;
            var grid = GetWorldGridWithDefaultLayer(serializer, cellSize, false);
            var entity = CreateEntity(serializer, new Position(1, 1, 1));
        ...
        public void AddEntity_Test2()
        {
            ...
            var cellSize = 50;
            var grid = GetWorldGridWithDefaultLayer(serializer, cellSize, false);
            var entity = CreateEntity(serializer, new Position(85, 5, 74));
            var cell = grid.AddEntity(entity);
            Assert.IsNotNull(cell);
        ...
        public void GetCellsInArea_Test()
        {
            ...
            var cellSize = 50;
            var grid = GetWorldGridWithDefaultLayer(serializer, cellSize, true);
        ...
        public void GetCellsInArea_Test2()
        {
            ...
            var grid = GetWorldGridWithDefaultLayer(serializer, cellSize, false);
            grid.AddEntity(CreateEntity(serializer, new Position(1, 1, 1)));
            grid.AddEntity(CreateEntity(serializer, new Position(5, 5, 5)));
            grid.AddEntity(CreateEntity(serializer, new Position(85, 5, 74)));
        ...
        public void GetCellsInArea_Test3()
        {
            ...
            grid.AddEntity(CreateEntity(serializer, new Position(1, 1, 1)));
            grid.AddEntity(CreateEntity(serializer, new Position(5, 5, 5)));
            grid.AddEntity(CreateEntity(serializer, new Position(126, 5, 100))); //(150, 0, 100)
            var cells = grid.GetCellsInArea(new Position(10, 1, 10), 100);
        ...
        public void GetCellsInArea_Test4()
        {
            ...
            var cellSize = 50;
            var grid = GetWorldGridWithDefaultLayer(serializer, cellSize, false);
            grid.AddEntity(CreateEntity(serializer, new Position(156, 5, 160))); //(150, 0, 150)
        ...
        public void GetCellsInArea_Test5()
        {
            ...
            var cellSize = 50;
            var grid = GetWorldGridWithDefaultLayer(serializer, cellSize, false);
            grid.AddEntity(CreateEntity(serializer, new Position(51.53, 1, 72.39003)));
        ...
        public void GetCellsInArea_Test6()
        {
            ...
            var cellSize = 50;
            var grid = GetWorldGridWithDefaultLayer(serializer, cellSize, false);
            grid.AddEntity(CreateEntity(serializer, new Position(-30, 1, -30)));
